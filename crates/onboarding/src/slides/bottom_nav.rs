...
pub fn onboarding_bottom_nav(
    ...
    // Dots sit on their own centered line above the buttons so longer button
    // labels (e.g. "I don't want AI") don't squish them toward center.
    ...
    // Equal-size flex slots pin Back to the left edge and Next to the right.
